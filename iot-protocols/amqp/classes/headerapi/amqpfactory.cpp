...
AMQPHeader *AMQPFactory::amqp(ByteArray *data)
{
    ...
    if (list->getTypeValue() != AMQP_LIST0_TYPE && list->getTypeValue() != AMQP_LIST8_TYPE && list->getTypeValue() != AMQP_LIST32_TYPE) {
        qDebug() << "AMQPFactory::amqp::wrong_type";
        return NULL;
    }
    ...
    switch(code->getValue()) {
        ...
        default:                            qDebug() << "AMQPFactory::amqp::wrong_message"; break;
    }
...
AMQPHeader *AMQPFactory::sasl(ByteArray *data)
{
    ...
    if (list->getTypeValue() != AMQP_LIST0_TYPE && list->getTypeValue() != AMQP_LIST8_TYPE && list->getTypeValue() != AMQP_LIST32_TYPE) {
        qDebug() << "AMQPFactory::sasl::wrong_type";
        return NULL;
    }
