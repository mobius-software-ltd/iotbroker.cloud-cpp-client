...
public:
    ...
    static QVariant *unwrap(TLVAMQP *value);
    ...
    static QDateTime unwrapTimestamp(TLVAMQP *tlv);
    static AMQPDecimal *unwrapDecimal(TLVAMQP *tlv);
    static int unwrapChar(TLVAMQP *tlv);
    static QString unwrapString(TLVAMQP *tlv);
    static AMQPSymbol *unwrapSymbol(TLVAMQP *tlv);
    static QByteArray unwrapBinary(TLVAMQP *tlv);
    static QUuid unwrapUUID(TLVAMQP *tlv);
    static QList<QVariant *> unwrapList(TLVAMQP *tlv);
    static QMap<QVariant *, QVariant *> unwrapMap(TLVAMQP *tlv);
    static QList<QVariant *> unwrapArray(TLVAMQP *tlv);
};
