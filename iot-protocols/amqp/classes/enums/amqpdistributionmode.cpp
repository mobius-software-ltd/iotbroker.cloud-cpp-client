...
AMQPDistributionMode::AMQPDistributionMode()
{
    ...
    this->map.insert(AMQP_MOVE_DISTRIBUTION_MODE, AMQP_MOVE_DISTRIBUTION_MODE_STRING);
    this->map.insert(AMQP_COPY_DISTRIBUTION_MODE, AMQP_COPY_DISTRIBUTION_MODE_STRING);
}
...
QString AMQPDistributionMode::getName()
{
