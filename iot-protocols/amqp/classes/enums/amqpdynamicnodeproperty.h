...
static QString const AMQP_SUPPORTED_DIST_MODES_DYNAMIC_NODE_PROPERTY_STRING = QString("supported-dist-modes");
static QString const AMQP_DURABLE_DYNAMIC_NODE_PROPERTY_STRING = QString("durable");
static QString const AMQP_AUTO_DELETE_DYNAMIC_NODE_PROPERTY_STRING = QString("auto-delete");
static QString const AMQP_ALTERNATE_EXCHANGE_DYNAMIC_NODE_PROPERTY_STRING = QString("alternate-exchange");
static QString const AMQP_EXCHANGE_TYPE_DYNAMIC_NODE_PROPERTY_STRING = QString("exchange-type");
