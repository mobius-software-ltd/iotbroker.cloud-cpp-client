...
AMQPRoleCode::AMQPRoleCode()
{
    ...
    this->map.insert(AMQP_SENDER_ROLE_CODE, AMQP_SENDER_ROLE_CODE_STRING);
    this->map.insert(AMQP_RECEIVER_ROLE_CODE, AMQP_RECEIVER_ROLE_CODE_STRING);
