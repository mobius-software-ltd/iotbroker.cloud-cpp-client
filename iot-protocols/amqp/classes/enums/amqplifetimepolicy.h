...
static QString const AMQP_DELETE_ON_CLOSE_LIFE_TIME_POLICY_STRING = QString("Delete on close");
static QString const AMQP_DELETE_ON_NO_LINKS_LIFE_TIME_POLICY_STRING = QString("Delete on no links");
static QString const AMQP_DELETE_ON_NO_MESSAGES_LIFE_TIME_POLICY_STRING = QString("Delete on no messages");
static QString const AMQP_DELETE_ON_NO_LINKS_OR_MESSAGES_LIFE_TIME_POLICY_STRING = QString("Delete on no links or messages");
