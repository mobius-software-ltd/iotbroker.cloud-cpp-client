...
public:
    ...
    QVariant *getSectionNumber() const;
    void setSectionNumber(QVariant *value);

    QVariant *getSectionOffset() const;
    void setSectionOffset(QVariant *value);
};
