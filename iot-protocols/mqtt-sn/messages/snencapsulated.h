...
private:
    ...
    SNRadius radius;
    QString wirelessNodeID;
    Message *message;

public:
    SNEncapsulated();
    SNEncapsulated(SNRadius radius, QString nodeID, Message *message);
    ...
    QString getWirelessNodeID() const;
    void setWirelessNodeID(const QString &value);
