...
SNPublish::SNPublish(int packetID, Topic *topic, QByteArray *content, bool isDup, bool isRetain)
{
...
QByteArray *SNPublish::getContent() const
{
    return content;
}

void SNPublish::setContent(QByteArray *value)
{
    content = value;
}
